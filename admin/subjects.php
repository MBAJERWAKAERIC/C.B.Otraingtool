        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					 <a href="add_subject.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Module</a>
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div style="font-size: 30px; font-family: Times New Roman; Times; serif;" class="muted pull-left">Module List</div>
                            </div>
