   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div style="font-size: 25px; font-family: Times New Roman; Times; serif" class="muted pull-left">Add C.B.O cluster</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form method="post">
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" id="focusedInput" name="d" type="text" placeholder = "C.B.O cluster">
                                          </div>
                                        </div>
