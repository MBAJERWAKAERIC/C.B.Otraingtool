...
<?php  include('session.php'); ?>
    <body style="color: blue; font-size: 15px;">
        ...
        <div class="container-fluid">
            <div style="color: blue; font-size: 17px;" class="row-fluid">
					<?php include('sidebar_dashboard.php'); ?>
                <!--/span-->
                <div class="span9" id="content">
                <div style="background-color: blue;" class="navbar navbar-inner block-header">
						<div style="color: blue;" class="row-fluid"></div>
						
                    <div style="background-color: green;" class="row-fluid">
            
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div style="background-color: black; font-size: 50px; font-family: Times New Roman; Times; serif;" class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Data Numbers</div>
                            </div>
                            <div class="block-content collapse in">
							        <div style="background-color: ;" class="span12">
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Active facilitotors</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Facilitators</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Trained C.B.O</strong>
                                ...
                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_student ?>"><?php echo $count_student ?></div>
                                    <div class="chart-bottom-heading"><strong>C.B.O</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Session</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading" ><strong>Modules</strong>
